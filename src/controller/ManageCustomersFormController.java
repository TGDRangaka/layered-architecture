...
public class ManageCustomersFormController {
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
                ...
                boolean isCustomerSaved = customerDAOimpl.saveCustomer(new CustomerDTO(id, name, address));
            ...
            try {
                ...
                boolean isUpdatedCustomer = customerDAOimpl.updateCustomer(new CustomerDTO(id, name, address));
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            boolean isDeletedCustomer = customerDAOimpl.deleteCustomer(id);
